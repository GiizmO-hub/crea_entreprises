...
/**
 * Script pour appliquer la migration de séparation clients/plateforme
 */
...
async function applyMigration() {
  ...
  try {
    ...
    const migrationFile = join(__dirname, '..', 'supabase', 'migrations', '20250131000018_fix_rls_separation_clients_plateforme.sql');
