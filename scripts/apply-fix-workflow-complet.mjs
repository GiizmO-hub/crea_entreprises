...
/**
 * Script pour appliquer la migration de correction du workflow complet
 */
...
async function applyMigration() {
  ...
  try {
    ...
    const migrationFile = join(__dirname, '..', 'supabase', 'migrations', '20250131000019_fix_workflow_complet_final.sql');
