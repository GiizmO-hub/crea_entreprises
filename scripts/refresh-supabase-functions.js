...
async function refreshFunctions() {
  ...
  try {
    ...
    // Forcer le rafraîchissement du cache en récréant la fonction
    ...
    console.log('📋 Fonctions trouvées:', rows);
    
    // Notifier PostgREST de recharger le schéma
    console.log('🔄 Tentative de rafraîchissement du cache...');
    await client.query('NOTIFY pgrst, "reload schema"');
    
    console.log('✅ Cache rafraîchi (si PostgREST est configuré pour écouter)');
