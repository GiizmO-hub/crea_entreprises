-- ============================================================================
-- FIX IMMÉDIAT : Supprimer toutes les références à v_paiement.facture_id
-- ============================================================================
-- 
-- PROBLÈME: Plusieurs fonctions essaient d'accéder à v_paiement.facture_id,
--           mais cette colonne n'existe pas dans la table paiements.
-- 
-- SOLUTION: Recréer toutes les fonctions concernées sans cette référence
-- 
-- INSTRUCTIONS:
...
-- Vérification
SELECT '✅ Fonction creer_facture_et_abonnement_apres_paiement corrigée avec succès !' as resultat;
