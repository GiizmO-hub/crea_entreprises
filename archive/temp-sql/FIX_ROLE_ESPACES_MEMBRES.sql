-- ============================================================================
-- CORRECTION RAPIDE : Retirer colonne role de espaces_membres_clients
-- ============================================================================
-- 
-- PROBLÈME:
-- La table espaces_membres_clients n'a pas de colonne "role"
-- Utiliser statut_compte = 'actif' à la place
-- ============================================================================
...
BEGIN
  ...
  -- CORRECTION : Pas de colonne role, utiliser statut_compte = 'actif'
