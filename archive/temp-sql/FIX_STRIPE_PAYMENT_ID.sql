-- ============================================================================
-- CORRECTION RAPIDE : Retirer stripe_payment_id de creer_facture_et_abonnement_apres_paiement
-- ============================================================================
...
BEGIN
  ...
  -- CORRECTION : Retirer stripe_payment_id (cette colonne n'existe pas dans abonnements)
