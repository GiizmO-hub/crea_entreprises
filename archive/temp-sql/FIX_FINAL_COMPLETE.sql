-- ============================================================================
-- CORRECTION FINALE COMPLÈTE : creer_facture_et_abonnement_apres_paiement
-- ============================================================================
-- 
-- Toutes les corrections appliquées :
-- 1. Retire statut_paiement de INSERT INTO factures
-- 2. Récupère entreprise_id depuis notes si NULL
-- 3. Retire stripe_payment_id de INSERT INTO abonnements
-- 4. Utilise v_user_id au lieu de v_client_id dans INSERT INTO abonnements
-- ============================================================================
...
BEGIN
  ...
  -- Créer facture SANS statut_paiement
  ...
  -- Créer abonnement : client_id référence auth.users(id), donc utiliser v_user_id
...
COMMENT ON FUNCTION creer_facture_et_abonnement_apres_paiement IS 
  'Crée automatiquement facture, abonnement, espace client avec droits admin après validation d''un paiement. Version corrigée finale.';
