...
export default function EntreprisesPlateforme() {
  ...
  const checkSuperAdmin = async () => {
    ...
    try {
      ...
      // Vérifier dans table utilisateurs
      ...
      if (!tableError && utilisateur && utilisateur.role === 'super_admin') {
        setIsSuperAdmin(true);
        return true;
      }
  ...
  const loadEntreprises = async () => {
    ...
    try {
      ...
      if (isSuperAdmin === true) {
        ...
        console.log('👑 Super Admin: chargement de TOUTES les entreprises');
      } else {
        // Utilisateur standard voit uniquement ses entreprises
                ...
                <>
                  ...
                  {formData.creer_client && (
                    <div className="space-y-4 p-4 bg-white/5 rounded-lg border border-white/10">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <label className="block text-sm font-medium text-gray-300 mb-2">Email client *</label>
                          <input
                            type="email"
                        ...
                        <div>
                          <label className="block text-sm font-medium text-gray-300 mb-2">Prénom client *</label>
                          <input
                            type="text"
                        ...
                        <div>
                          <label className="block text-sm font-medium text-gray-300 mb-2">Téléphone client</label>
                          <input
                            type="tel"
