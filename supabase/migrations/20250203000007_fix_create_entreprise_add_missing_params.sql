-- ============================================================================
-- FIX URGENT : Ajouter les paramètres manquants à create_complete_entreprise_automated
-- ============================================================================
-- 
-- PROBLÈME: Le frontend envoie p_code_ape, p_code_naf, p_convention_collective
--           mais la fonction en base ne les a pas.
-- 
-- SOLUTION: Recréer la fonction avec TOUS les paramètres nécessaires
--           en utilisant le fichier tampon shared.ts comme référence
-- 
-- ============================================================================

-- Supprimer toutes les versions existantes
DROP FUNCTION IF EXISTS create_complete_entreprise_automated(text, text, text, text, text, text, text, text, numeric, text, text, text, text, text, text, text, text, text, text, text, uuid, uuid[], boolean, boolean) CASCADE;
DROP FUNCTION IF EXISTS create_complete_entreprise_automated(text, text, text, text, text, text, text, text, numeric, text, text, text, text, text, text, text, text, text, text, uuid, uuid[], boolean, boolean, text, text, text) CASCADE;

-- Recréer avec TOUS les paramètres
CREATE OR REPLACE FUNCTION create_complete_entreprise_automated(
  ...
  -- ✅ PARAMÈTRES AJOUTÉS (utilisés par le module comptabilité)
