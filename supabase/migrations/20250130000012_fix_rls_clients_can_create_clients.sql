/*
  ...
  afin de permettre aux utilisateurs de l'espace client de créer des clients
  pour leur entreprise.
  
  Les utilisateurs peuvent créer des clients si :
...
-- Fonction helper pour vérifier si l'utilisateur est propriétaire de l'entreprise (super_admin ou propriétaire)
