/*
  ...
  PROBLÈME:
  - La fonction gen_salt() n'est pas trouvée car l'extension pgcrypto n'est pas activée
  - Le search_path ne contient pas 'extensions'
  
  SOLUTION:
  - Activer l'extension pgcrypto
  - Modifier le search_path de la fonction pour inclure 'extensions'
*/

-- 1. Activer l'extension pgcrypto
CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- 2. Re-créer la fonction avec le bon search_path
...
COMMENT ON FUNCTION create_espace_membre_from_client_unified IS 'Crée un espace membre client avec auth user, abonnement et synchronisation des modules. Version unifiée consolidée. FIX: Extension pgcrypto activée et search_path inclut extensions.';
