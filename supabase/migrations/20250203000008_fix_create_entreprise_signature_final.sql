...
-- 
-- Utilise le fichier tampon (src/types/shared.ts) pour la cohérence des types
-- 
-- ============================================================================

-- Supprimer toutes les versions existantes
DROP FUNCTION IF EXISTS public.create_complete_entreprise_automated CASCADE;

-- Créer la fonction avec la signature EXACTE (sans DEFAULT pour correspondre au frontend)
...
BEGIN
  ...
  -- Normaliser les valeurs (utilise le fichier tampon shared.ts pour cohérence)
  ...
  -- 4. Créer l'entreprise AVEC statut_paiement (utilise les champs du fichier tampon shared.ts)
